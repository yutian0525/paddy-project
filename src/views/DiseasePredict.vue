  ...
  methods: {
    ...
    async uploadImage() {
      try {
        ...
        this.imageUrl = "http://127.0.0.1:5000/ShowImg/DiseaseImage/" + response.data.data;
    ...
    async predictImage() {
      try {
        ...
        this.predictedImg = "http://127.0.0.1:5000/ShowImg/PredictDiseaseImage/" + this.imgname;
